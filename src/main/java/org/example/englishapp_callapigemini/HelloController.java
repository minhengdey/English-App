...
//
//
//    private List<String> loadWordSuggestions(String language, String text) throws IOException {
//
//        text = text.toLowerCase();
//
//        String encodedText = java.net.URLEncoder.encode(text, StandardCharsets.UTF_8);
//        String urlStr = String.format("http://localhost:8080/%s/top10Word/%s", language, encodedText);
//        URL url = new URL(urlStr);
//
//        HttpURLConnection connEng = (HttpURLConnection) url.openConnection();
...
//
//    @FXML
//    private void handleTextInput(KeyEvent event) throws IOException {
...
//            wordSuggestionsEng = loadWordSuggestions("english_to_vietnamese", text);
//            matches = wordSuggestionsEng.stream()
//                    .filter(word -> word.startsWith(text))
//                    .limit(10)
//                    .collect(Collectors.toList());
//        } else {
//            wordSuggestionsViet = loadWordSuggestions("vietnamese_to_english", text);
